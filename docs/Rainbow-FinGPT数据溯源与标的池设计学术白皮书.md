...
为了彻底消除评委对“小样本挑选偏差”的疑虑，项目在底层运行了涵盖 **202 支股票、全市场 6 大风格主力组合** 的 60 交易日因果回测（落地于 [`data/raw/backtest_paper_60d_202stocks/`](file:///d:/R-FinGPTv2%EF%BC%88%E5%9B%BD%E5%88%9B%E7%89%88%E6%9C%AC%EF%BC%89/Rainbow_FinGPTv2/data/raw/backtest_paper_60d_202stocks/) 与 [`accuracy_and_performance_report.md`](file:///d:/R-FinGPTv2%EF%BC%88%E5%9B%BD%E5%88%9B%E7%89%88%E6%9C%AC%EF%BC%89/Rainbow_FinGPTv2/reports/tables/backtest_paper_60d_202stocks/accuracy_and_performance_report.md)）：

- **样本规模**：202 支横跨科技、激进成长、稳健均衡、蓝筹价值、全球配置、防御保守的 A 股股票及主流宽基 ETF。
- **总预测样本量**：$202 \times 59 = 11,918$ 个独立日频因果预测样本点。
- **计量经济学检验结果**：
  ...
  - **全池等权基准对照**：在 60 交易日大盘震荡下跌中（沪深 300 下跌 $-6.02\%$，202 全池等权下跌 $-4.87\%$），系统 6 大组合全部录得正收益（收益率在 $+7.40\%$ 至 $+21.48\%$），最大回撤控制在 $1.85\% \sim 5.12\%$。
...
| **回测样本点** | **11,918 个独立日频因果预测点** | **260~280 个连续交易日因果时序** |
