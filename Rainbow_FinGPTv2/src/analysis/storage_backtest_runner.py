# -*- coding: utf-8 -*-
"""src/analysis/storage_backtest_runner.py —— 2025Q2-2026Q3 存储超级周期板块物理隔离拟真交易人逐步推进回测执行器（增强版）
...
4. 市场状态机与动态仓位管理（BULL/BEAR/SIDEWAYS三状态 + 回撤惩罚 + 波动率调整）
5. A股机构真实费率（买入 0.125%，卖出 0.175%，闲置现金年化 1.8%）
6. 三级对照组基准矩阵（沪深300、存储ETF、存储核心5巨头等权买入持有）
"""
