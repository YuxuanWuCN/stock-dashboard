...
**应用的调参**:
- [HIGH] probability_threshold: 当前对齐率 34.7% < 50%，存在乐观偏差，建议提高概率阈值
- [MEDIUM] portfolio_strategy: 激进组合跑赢稳健组合 3.19%，可提高动量权重
- [LOW] scoring_weights: 需要更多交易日数据（建议 ≥10 天）才能准确评估各因子贡献

**备份时间戳**: 20260815_171859
**校准报告**: `calibration_report_20260815_165749.json`
