...
> 📖 **English academic paper** (Wu Yuxuan, Aberdeen Institute of Data Science and Artificial Intelligence, South China Normal University) is available at [README.md](README.md).
...
```
stock-dashboard/
├── README.md                   英文论文版（升学展示）
├── README_CN.md                 中文项目说明（从零配置教程）
├── AGENTS.md                   质量门禁规则
